...
export default function Hero() {
    ...
    return (
        <div className="flex min-h-[20em] lg:min-h-[30em] justify-center items-center bg-gradient-to-r from-gray-900 via-blue-950 to-blue-950/1 relative overflow-hidden">
